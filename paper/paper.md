...
At the time of writing (software version 2.1.1), this includes the following properties:
...
We note that no AI was used in writing the unit test suite enforcing accuracy of the software, which allowed us to ensure that the generated code produced correct results.
